...
const LoginPage = () => {
  ...
  const [resetLinkButtonText, setResetLinkButtonText] =
    useState("Send Reset Link");
  ...
  const validateCredentials = () => {
    ...
    if (!isValidPassword(password)) {
      setModalMessage(
        "The password format is invalid. It must contain at least 8 characters, including uppercase, lowercase, numbers, and special characters."
      );
      setShowModal(true);
      return false;
    }
