...
function TicketBookingPage() {
  ...
  const canAddTicket = (count) =>
    totalTickets < availableSeats && count < availableSeats;
    ...
    <div className="ticket-page">
      <div className="ticket-container">
          ...
          <div className="card-body">
            ...
            <div>
              <button
                ...
                onClick={() =>
                  canAddTicket(adultCount) && setAdultCount(adultCount + 1)
                }
              >
                +
              </button>
          ...
          <div className="card-body">
            ...
            <div>
              <button
                className="btn btn-primary"
                onClick={() =>
                  canAddTicket(childCount) && setChildCount(childCount + 1)
                }
              >
                +
              </button>
          ...
          <div className="card-body">
            ...
            <div>
              <button
                className="btn btn-primary"
                onClick={() =>
                  canAddTicket(seniorCount) && setSeniorCount(seniorCount + 1)
                }
              >
                +
              </button>
              ...
              <button
                className="btn btn-primary"
                onClick={() =>
                  seniorCount > 0 && setSeniorCount(seniorCount - 1)
                }
              >
                -
              </button>
        ...
        <div className="ticket-action-container">
          <Button
            variant="primary"
            className="ticket-confirm-button"
