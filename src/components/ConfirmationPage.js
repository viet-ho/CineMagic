        ...
        <main className="main-container">
          <section className="movie-details">
            <img
              ...
              alt="Movie Poster"
              className="movie-poster-confirm"
            />
            <div>
              ...
              <p>
                <strong>Location:</strong> {movieDetails.location}
              </p>
            </div>
          </section>
          <hr />
          <section className="ticket-details">
            <h2>Your Tickets</h2>
            <p>
              <strong>Adult Tickets:</strong> {ticketDetails.adultTickets}
            </p>
            <p>
              <strong>Youth Tickets:</strong> {ticketDetails.youthTickets}
            </p>
            <p>
              <strong>Senior Tickets:</strong> {ticketDetails.seniorTickets}
            </p>
            <p>
          ...
          <section className="user-details">
            ...
            <p>
              <strong>Payment Method:</strong> {userDetails.paymentMethod}
            </p>
            <p>
              <strong>Promo Code:</strong> {userDetails.promoCode}
            </p>
          </section>
          <hr />
          <section className="price-details">
            ...
            <p>
              <strong>Promo Discount:</strong> -${priceDetails.discount}
            </p>
            <p>
              <strong>Taxes:</strong> ${priceDetails.taxes}
            </p>
            <p>
              <strong>Booking Fees:</strong> ${priceDetails.bookingFee}
            </p>
            <p>
              <strong>Total: ${priceDetails.total}</strong>
            </p>
          </section>
